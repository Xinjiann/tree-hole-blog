<template>
  <el-card>
    <h1 class="me-author-name">Xinjian</h1>
    <div class="me-author-description">
      <span><i class="el-icon-location-outline"></i> &nbsp;南京航空航天大学</span>
...
<script>
  export default {
    ...
    data() {
      return {
        qq: {title: 'QQ', message: 'QQ：963597661  微信：Xinjian_Li1'},
        github: {
          title: 'github',
          message: '<a target="_blank" href="https://github.com/Xinjiann">https://github.com/Xinjiann</a>'
        }
      }
    },
    methods: {
